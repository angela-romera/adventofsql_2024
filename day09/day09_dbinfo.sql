...
-- -- test data
-- INSERT INTO reindeers_test (reindeer_id, reindeer_name, years_of_service, speciality) VALUES
--     (1, 'Dasher', 287, 'Sprint Master'),
--     (2, 'Dancer', 283, 'Agility Expert'),
--     (3, 'Prancer', 275, 'High-Altitude Specialist'),
--     (4, 'Comet', 265, 'Long-Distance Expert'),
--     (5, 'Rudolf', 152, 'Night Navigation');

-- INSERT INTO training_sessions_test (reindeer_id, exercise_name, speed_record, session_date, weather_conditions) VALUES
